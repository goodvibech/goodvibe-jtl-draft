Here is a `README.md` file for your WordPress plugin. It explains the code logic, features, and technical details clearly, suitable for a public repository and team collaboration.
...
- **Security Best Practices:** Sanitizes input, avoids leaking sensitive information, and prevents direct file access. Debug logging is protected—only enabled under WP_DEBUG.
...
- **Debug Logging:** Logs the prevention of delete/trash actions during debugging (no personal data exposure).
